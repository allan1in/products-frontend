    ...
    <div className="min-h-screen">
      <nav className="bg-white h-16 w-full fixed z-10 flex items-center px-4 gap-4">
        <div className="grow h-[70%] bg-gray-200 rounded-[99999px] flex items-center px-4">
          <div className="h-[50%]">
            <LuSearch className="text-gray-600 size-full" />
          </div>
        ...
        <div className="relative h-[70%]" ref={sortMenuRef}>
          <button
            className="px-4 h-full rounded-[99999px] border border-gray-300 cursor-pointer hover:bg-gray-200 active:bg-gray-300 text-sm whitespace-nowrap transition flex items-center justify-center gap-2"
          ...
          {showSortMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
              <button
                className={`w-full px-4 py-3 text-left text-sm hover:bg-gray-200 active:bg-gray-300 transition cursor-pointer ${
            ...
            {!isLoading && pageCount > 0 ? (
              <div className="flex flex-col gap-4">
                <div className="flex justify-center gap-4">
                  {page > 1 ? (
                    <button
                      className="px-4 py-3 rounded-[99999px] border border-gray-300 text-sm cursor-pointer flex items-center hover:bg-gray-200 active:bg-gray-300 transition"
